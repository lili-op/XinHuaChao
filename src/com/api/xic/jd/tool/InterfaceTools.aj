...
public class InterfaceTools {
    ...
    //获取批量查询的总页数
    public static int Selectpages(int page,JSONObject data,String url) throws Exception {
    ...
    //获取批量查询数据
    public static JSONObject SelectData(int ii,JSONObject data,String url) throws Exception {
        JSONObject json2 = new JSONObject();
    ...
    //根据主键查询数据
    public static JSONObject selectConditionId(JSONObject data,String url,int zid) throws Exception {
